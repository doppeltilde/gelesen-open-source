...
final heading1 = Styles(
  color: textBlack,
  fontSize: 4.rem,
  fontWeight: FontWeight.w800,
);
final heading2 = Styles(
  color: textBlack,
  fontSize: 3.rem,
  fontWeight: FontWeight.w700,
);
final heading3 = Styles(
  color: textBlack,
  fontSize: 2.5.rem,
  fontWeight: FontWeight.w700,
);
final heading4 = Styles(
  color: textBlack,
  fontSize: 1.5.rem,
  fontWeight: FontWeight.w700,
);
final heading5 = Styles(
  color: textBlack,
  fontSize: 1.rem,
...
List<StyleRule> get root => [
  ...
  css.import(
    'https://fonts.googleapis.com/css2?family=Alata&family=Lexend:wght@100..900&display=swap',
  ),
  ...
  css('.theme-image-swap', [
    css('.dark-image-only').styles(display: Display.none),
  ]),

  css(':root.dark .theme-image-swap', [
    css('.light-image-only').styles(display: Display.none),
    css('.dark-image-only').styles(display: Display.initial),
  ]),
  ...
  css('ul').combine(bodyMedium),
  css('li').combine(bodyMedium),
  css('h1')
      .combine(heading1)
      .styles(
  ...
  css('.animated-underline', [
    ...
    css(
      '&:hover',
    ).styles(backgroundSize: BackgroundSize.sides(100.percent, 1.5.px)),
  ]),
];
